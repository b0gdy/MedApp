...
@Component({
  selector: 'app-pacient-appointments',
  templateUrl: './pacient-appointments.component.html',
  styleUrls: ['./pacient-appointments.component.css']
})
export class PacientAppointmentsComponent implements OnInit {
