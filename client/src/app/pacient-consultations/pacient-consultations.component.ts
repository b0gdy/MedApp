...
@Component({
  selector: 'app-pacient-consultations',
  templateUrl: './pacient-consultations.component.html',
  styleUrls: ['./pacient-consultations.component.css']
})
export class PacientConsultationsComponent implements OnInit {
